...
public class NotificationServiceImpl implements NotificationService{
    ...
    public boolean confirm(String token) {
        Date date = new Date();
        boolean expired = tokenRepo.findAllByExpiryDateBefore(new Timestamp(date.getTime())).stream().anyMatch(t -> t.getId().equals(token));
    ...
    private String messageBuilder(String header, String username, String message, String button_text,
